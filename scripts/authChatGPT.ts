...
async function main() {
    const authFile = path.join(__dirname, "../.auth/chatgpt.json");

    console.log("🚀 Launching interactive browser for ChatGPT login...");
    ...
    console.log("🌐 Navigating to ChatGPT login...");
